...
execute if score server tick_counter matches 20 run function sa:dungeon/floor1/dungeon_1/tick
execute if score server tick_counter matches 20 run function sa:dungeon/floor1/dungeon_2/tick
