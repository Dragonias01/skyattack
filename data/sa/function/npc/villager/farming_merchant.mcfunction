...
lore:[[{text:"Compressed Biomass",italic:false,color:dark_aqua}],"",[{text:Rare,bold:true,italic:false,color:blue}]],\
...
custom_name:[{text:"Speed Potion II",italic:false,color:blue}],\
lore:[[{text:"Grants Speed II for one hour",italic:false,color:gray}],"",[{text:Rare,bold:true,italic:false,color:blue}]],\
...
lore:[[{text:"Increases Farming XP gain for one hour",italic:false,color:gray}],"",[{text:Uncommon,bold:true,italic:false,color:green}]],\
