...
lore:[[{text:"Double compressed fish",italic:false,color:dark_aqua}],"",[{text:Rare,bold:true,italic:false,color:blue}]],\
...
lore:[{text:" "},{text:"+",extra:[{text:"100",extra:[{text:"% Fishing Yield ",color:gray}],color:green}],color:gray,italic:false},{text:Uncommon,bold:true,italic:false,color:green,underlined:false,strikethrough:false,obfuscated:false}],\
...
custom_name:[{text:"Luck Potion",italic:false,color:blue}],\
