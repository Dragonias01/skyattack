  ...
  Offers:{Recipes:[\
    ...
    {maxUses:99999,rewardExp:0b,priceMultiplier:0,demand:0,specialPrice:0,\
      ...
      sell:{id:"minecraft:potion",count:1,components:{\
        ...
        custom_name:[{text:"Widerstandstrank II",italic:false,color:blue}],\
        lore:[[{text:"Gewährt Widerstand II für eine Stunde",italic:false,color:gray}],"",[{text:Rare,bold:true,italic:false,color:blue}]],\
