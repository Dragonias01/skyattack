...
execute if score server lb_tick matches 200.. run function sa:leaderboard/logging/update

# ── Counter zurücksetzen ──────────────────────────────────────────────────
execute if score server lb_tick matches 200.. run scoreboard players set server lb_tick 0
