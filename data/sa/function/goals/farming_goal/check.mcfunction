...
execute if score @s temp_hub_farming matches 0 run tellraw @s [{"text":"Du hast keine Double Compressed Fish!","color":"red"}]
...
tellraw @s [{"text":"Du hast ","color":"green"},{"score":{"name":"@s","objective":"temp_hub_farming"},"color":"green"},{"text":" Double Compressed Fish abgegeben!","color":"green"}]
