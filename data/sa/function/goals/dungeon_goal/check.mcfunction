...
execute if score @s temp_hub_dungeon matches 0 run tellraw @s [{"text":"Du hast keine Mob Mesh!","color":"red"}]
...
execute if score server hub_dungeon_rem matches ..0 run tellraw @s [{"text":"Das Abgabe-Ziel ist bereits erfuellt!","color":"red"}]
...
tellraw @s [{"text":"Du hast ","color":"green"},{"score":{"name":"@s","objective":"temp_hub_dungeon"},"color":"green"},{"text":" Mob Mesh abgegeben!","color":"green"}]
