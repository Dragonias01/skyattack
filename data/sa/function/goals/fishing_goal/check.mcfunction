...
# ── Dependency: Mining Raum ───────────────────────────────────────────────
    execute unless score server hub_mining_done matches 1 run tellraw @s [{"text":"Dependency not met! (Mining Room)","color":"red"}]
...
# ── Schritt 2: Keine Items → Fehlermeldung & Abbruch ─────────────────────
    execute if score @s temp_hub_fishing matches 0 run tellraw @s [{"text":"You have no Double Compressed Stone!","color":"red"}]
...
# ── Schritt 5: Goal bereits voll → Abbruch ───────────────────────────────
    execute if score server hub_fishing_rem matches ..0 run tellraw @s [{"text":"The delivery goal is already fulfilled!","color":"red"}]
...
# ── Schritt 9: Bestaetigung ───────────────────────────────────────────────
    tellraw @s [{"text":"You have given ","color":"green"},{"score":{"name":"@s","objective":"temp_hub_fishing"},"color":"green"},{"text":" Double Compressed Stone!","color":"green"}]
