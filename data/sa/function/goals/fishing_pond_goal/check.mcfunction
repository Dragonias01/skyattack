...
# ── Schritt 2: Keine Level → Fehlermeldung & Abbruch ─────────────────────
    execute if score @s temp_hub_fishpond matches ..0 run tellraw @s [{"text":"You don't have enough levels!","color":"red"}]
...
# ── Schritt 5: Goal bereits voll → Abbruch ───────────────────────────────
    execute if score server hub_fishpond_rem matches ..0 run tellraw @s [{"text":"The delivery goal is already fulfilled!","color":"red"}]
...
# ── Schritt 9: Bestätigung ────────────────────────────────────────────────
    tellraw @s [{"text":"You have given ","color":"green"},{"score":{"name":"@s","objective":"temp_hub_fishpond"},"color":"green"},{"text":" levels!","color":"green"}]
