...
# ── Dependency: Farming Raum ──────────────────────────────────────────────
    execute unless score server hub_farming_done matches 1 run tellraw @s [{"text":"Dependency not met! (Farming Room)","color":"red"}]
...
# ── Schritt 2: Keine Items → Fehlermeldung & Abbruch ─────────────────────
    execute if score @s temp_hub_combat matches 0 run tellraw @s [{"text":"You have no Double Compressed Crop!","color":"red"}]
...
# ── Schritt 5: Goal bereits voll → Abbruch ───────────────────────────────
    execute if score server hub_combat_rem matches ..0 run tellraw @s [{"text":"The delivery goal is already fulfilled!","color":"red"}]
...
# ── Schritt 9: Bestaetigung ───────────────────────────────────────────────
    tellraw @s [{"text":"You have given ","color":"green"},{"score":{"name":"@s","objective":"temp_hub_combat"},"color":"green"},{"text":" Double Compressed Crop!","color":"green"}]
