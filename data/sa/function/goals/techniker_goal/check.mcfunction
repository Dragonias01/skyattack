...
# ── Dependency: Dungeon ─────────────────────────────────────────────────
# TODO: SERVER PROGRESS SYSTEM - Durch Fortschrittspruefung ersetzen
execute unless score server hub_dungeon_done matches 1 run tellraw @s [{"text":"Voraussetzung nicht erfuellt! (Dungeon)","color":"red"}]
...
execute if score @s temp_hub_techniker matches 0 run tellraw @s [{"text":"Du hast keine Techniker-Ressource!","color":"red"}]
...
execute if score server hub_techniker_rem matches ..0 run tellraw @s [{"text":"Das Abgabe-Ziel ist bereits erfuellt!","color":"red"}]
...
tellraw @s [{"text":"Du hast ","color":"green"},{"score":{"name":"@s","objective":"temp_hub_techniker"},"color":"green"},{"text":" Techniker-Ressource abgegeben!","color":"green"}]
