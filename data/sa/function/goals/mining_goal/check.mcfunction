...
# ── Dependency: Skill Rooms ───────────────────────────────────────────────
    ...
    # ── Schritt 2: Keine Items → Fehlermeldung & Abbruch ─────────────────────
        execute if score @s temp_hub_mining matches 0 run tellraw @s [{"text":"you have no Double Compressed Logs!","color":"red"}]
    ...
    # ── Schritt 5: Goal bereits voll → Abbruch ───────────────────────────────
        execute if score server hub_mining_rem matches ..0 run tellraw @s [{"text":"The delivery goal is already completed!","color":"red"}]
    ...
    # ── Schritt 9: Bestaetigung ───────────────────────────────────────────────
        tellraw @s [{"text":"You have given ","color":"green"},{"score":{"name":"@s","objective":"temp_hub_mining"},"color":"green"},{"text":" Double Compressed Logs!","color":"green"}]
