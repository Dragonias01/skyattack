...
# ── Insel 8 │ X=-177  Z=-177 (Nord-West) ─────────────────────────────────
    ...
    execute if score server current matches 0 unless score server i8 matches 1 run tellraw @s [{"text":"[Server] ","color":"yellow"},{"text":"Island 8 joined!","color":"green"}]
...
# ── Insel 7 │ X=-250  Z=0   (West) ──────────────────────────────────────
    ...
    execute if score server current matches 0 unless score server i7 matches 1 run tellraw @s [{"text":"[Server] ","color":"yellow"},{"text":"Island 7 joined!","color":"green"}]
...
# ── Insel 6 │ X=-177  Z=177  (Süd-West) ─────────────────────────────────
    ...
    execute if score server current matches 0 unless score server i6 matches 1 run tellraw @s [{"text":"[Server] ","color":"yellow"},{"text":"Island 6 joined!","color":"green"}]
...
# ── Insel 5 │ X=0     Z=250  (Süd) ──────────────────────────────────────
    ...
    execute if score server current matches 0 unless score server i5 matches 1 run tellraw @s [{"text":"[Server] ","color":"yellow"},{"text":"Island 5 joined!","color":"green"}]
...
# ── Insel 4 │ X=177   Z=177  (Süd-Ost) ──────────────────────────────────
    ...
    execute if score server current matches 0 unless score server i4 matches 1 run tellraw @s [{"text":"[Server] ","color":"yellow"},{"text":"Island 4 joined!","color":"green"}]
...
# ── Insel 3 │ X=250   Z=0    (Ost) ──────────────────────────────────────
    ...
    execute if score server current matches 0 unless score server i3 matches 1 run tellraw @s [{"text":"[Server] ","color":"yellow"},{"text":"Island 3 joined!","color":"green"}]
...
# ── Insel 2 │ X=177   Z=-177 (Nord-Ost) ─────────────────────────────────
    ...
    execute if score server current matches 0 unless score server i2 matches 1 run tellraw @s [{"text":"[Server] ","color":"yellow"},{"text":"Island 2 joined!","color":"green"}]
...
# ── Insel 1 │ X=0     Z=-250 (Nord) ─────────────────────────────────────
    ...
    execute if score server current matches 0 unless score server i1 matches 1 run tellraw @s [{"text":"[Server] ","color":"yellow"},{"text":"Island 1 joined!","color":"green"}]
