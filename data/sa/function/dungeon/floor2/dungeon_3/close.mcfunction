...
# teleport players out of dungeon dimension
    execute in sa:dungeon1 as @a[tag=dg3_in_dungeon] run tp @s 0 100 0
    execute in sa:dungeon1 as @a[tag=dg3_in_dungeon] run execute in sa:hub run tp @s 0 100 0

# teleport players out of boss dimension
    execute in sa:dungeon_arena_1 as @a[tag=dg3_in_dungeon] run tp @s[tag=dg3_in_dungeon] 0 100 0
    execute in sa:dungeon_arena_1 as @a[tag=dg3_in_dungeon] run execute in sa:hub run tp @s[tag=dg3_in_dungeon] 0 100 0
...
# reset values
    ...
    #TODO: scoreboard players set server f1_boss_state 0
