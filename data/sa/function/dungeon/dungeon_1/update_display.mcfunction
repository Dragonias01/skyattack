...
# --- INAKTIV ---
    execute if score server dungeon_1_status matches 0 run data modify entity @e[type=text_display,tag=d1_display_players,limit=1] text set value {"text":"Player: ---","color":"gray","italic":false}
