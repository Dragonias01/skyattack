...
execute as @a[tag=dg1_in_dungeon] run function sa:dungeon/floor1/arena/on_enter_boss
execute as @a[tag=dg2_in_dungeon] run function sa:dungeon/floor1/arena/on_enter_boss
