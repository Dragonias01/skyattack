...
# Level 5 = 005
    ...
    execute as @s[scores={combat_collection_collect=5}] if score @s zombie_collection_progress matches 4 if score @s zombie_collected matches 1000.. run recipe give @s armor/zombie_set/zombie_helmet
    execute as @s[scores={combat_collection_collect=5}] if score @s zombie_collection_progress matches 4 if score @s zombie_collected matches 1000.. run recipe give @s armor/zombie_set/zombie_chestplate
    execute as @s[scores={combat_collection_collect=5}] if score @s zombie_collection_progress matches 4 if score @s zombie_collected matches 1000.. run recipe give @s armor/zombie_set/zombie_leggings
    execute as @s[scores={combat_collection_collect=5}] if score @s zombie_collection_progress matches 4 if score @s zombie_collected matches 1000.. run recipe give @s armor/zombie_set/zombie_boots
