...
# Mining
    ...
    # Farming
        execute as @s[scores={farming_collection_collect=0..100}] run function sa:menue/collections/farming/claim_potato
        execute as @s[scores={farming_collection_collect=101..}] run tellraw @s {text:"Cannot claim an not implemented Collection",color:"red"}
        # Fishing
            execute as @s[scores={fishing_collection_collect=0..100}] run function sa:menue/collections/fishing/claim_fishes
            execute as @s[scores={fishing_collection_collect=101..}] run tellraw @s {text:"Cannot claim an not implemented Collection",color:"red"}
