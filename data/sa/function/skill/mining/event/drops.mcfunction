execute as @e[type=item,nbt={Item:{id:"minecraft:structure_void"}}] at @s if entity @p[distance=..7] run data merge entity @s {CustomName:"stone_with_drops"}
execute as @e[type=item,nbt={CustomName:"stone_with_drops"}] at @s run loot spawn ~ ~ ~ loot minecraft:blocks/stone
...
execute at @s if score @s m_drop_menge >= @s m_Drops run execute as @e[type=item,nbt={CustomName:"stone_with_drops"}] at @s run loot spawn ~ ~ ~ loot minecraft:blocks/stone
...
kill @e[type=item,nbt={CustomName:"stone_with_drops"}]