...
execute at @s if score @s combat_drop_menge >= @s combat_drops run execute as @e[type=item,nbt={Item:{components:{"minecraft:item_name":"stone_with_drops"}}}] at @s run loot spawn ~ ~ ~ loot minecraft:bonus/stone
