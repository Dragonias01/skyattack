...
# Level 1-20: Anstieg um 5%
    ...
    execute at @s if score @s combat_drop_menge >= @s combat_drops run execute as @e[type=item,nbt={Item:{components:{"minecraft:item_name":"skeleton_drop"}}}] at @s run loot spawn ~ ~ ~ loot minecraft:bonus/mobs/skeleton
...
kill @e[type=item,nbt={Item:{components:{"minecraft:item_name":"skeleton_drop"}}}]
