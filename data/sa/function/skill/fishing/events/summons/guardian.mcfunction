...
# Guardian an Spieler-Position summonen (etwas über Spieler)
    summon guardian ~ ~1 ~ {Health:20,Motion:[0d,0.2d,0d],Tags:["fishing_creature","guardian_fished"],attributes:[{id:max_health,base:20f}],DeathLootTable:"sa:mobs/fishing/guardian"}
...
# Nachricht an Spieler
    tellraw @p[distance=0..30] [{"text":"🐋 Guardian ","color":"aqua","bold":true},{"text":"has attacked you!","color":"blue"}]
