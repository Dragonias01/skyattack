...
# Guardian an Spieler-Position summonen (etwas über Spieler)
    summon bogged ~ ~1 ~ {Health:20,Motion:[0d,0.2d,0d],Tags:["fishing_creature","bogged_fished"],attributes:[{id:max_health,base:20f}],DeathLootTable:"sa:mobs/fishing/bogged"}
