...
# 4. Storage Text setzen
    data modify storage sa:goal_ship_text text set value [{"score":{"objective":"goal_ship","name":"server"},"color":"green"},{"text":"/25","color":"white"},{"score":{"objective":"goal1_cost","name":"server"},"color":"white"}]
