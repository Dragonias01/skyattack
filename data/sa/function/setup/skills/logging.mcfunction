...
scoreboard objectives add logging_multiplier_num dummy "logging Goal Multiplier (Numerator)"
scoreboard objectives add logging_multiplier_den dummy "logging Goal Multiplier (Denominator)"

scoreboard players set server logging_multiplier_num 11
scoreboard players set server logging_multiplier_den 10
