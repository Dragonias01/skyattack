...
data modify storage sa:config goals.skillroom_goal set value {initial_cost:25,cost_per_player:25,current_cost:25,goal_completed:0b,goal_progress:0,item:"minecraft:basalt",item_name:"compressed_log",success_text:"Compressed Logs",max_per_use:10,display_tag:"display_skillrooms",reward_function:"sa:goals/skillrooms_goal/reward",uses_xp:0b,has_dependency:0b,dependency_objective:"",dependency_value:0,dependency_name:""}
...
data modify storage sa:config goals.combat_goal set value {initial_cost:50,cost_per_player:50,current_cost:50,goal_completed:0b,goal_progress:0,item:"minecraft:paper",item_name:"double_compressed_crop",success_text:"Double Compressed Crop",max_per_use:10,display_tag:"display_combat",reward_function:"sa:goals/combatgoal/reward",uses_xp:0b,has_dependency:0b,dependency_objective:"",dependency_value:0,dependency_name:""}
