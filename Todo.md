...
Goals:
[Progress unbinded]
- goal_ship (Ressource: Mob Mesh 25xpro Spieler) [Schaltet dass Flugschiff Frei mit dem man in den Hub kommt] pos: -6 102 10 in minecraft:overworld
- Levelbaum_goal (ressource: Level 1000xpro Spieler) [Schaltet den LEvelbaum Frei] pos: 0 99 10
- Dungeon_goal (ressource: Mob Meshl 50xpro Spieler) [Schaltet den Dungeon Hub frei] pos: 13 99 5 in sa:hub
- skillrooms_goal (ressource: Compressed_stone 200xpro Spieler) [Reward: Schaltet einen verteiler Raum für die Skills frei und den Raum für Logging.] pos: 0 99 -22 in sa:hub
[progress binded]
- Mining_goal (ressource: double_compressed_log 100xpro Spieler) [Schaltet den Mining Raum Frei, Dependencie: Skillrooms goal]
...
- Fishing_pond_goal (ressource: Experience 1000xpro Spieler) [Schaltet den Fishing Pond Frei, Dependencie: Fishing_goal] pos: 0 99 22 in sa:hub
